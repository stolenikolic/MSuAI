...
def binary_output(frame):
    ...
    grad_binary = abs_sobel_thresh(img, orient='x', thresh_min=50, thresh_max=100)

    # Primjena color filtera
    color_binary = color_threshold(img, thresh=(170, 255))
...
if __name__ == "__main__":
    # binary_image = binary_output('../test_images/solidYellowLeft.jpg')
    binary_image = binary_output('../test_images/test6.jpg')
