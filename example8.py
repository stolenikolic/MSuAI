...
from example2 import binary_output  # Funkcija za binarnu sliku
from example5 import bird_eye  # Funkcija za bird-eye perspektivu
from example6 import lane_detection  # Funkcija za detekciju linija
from example7 import original_image_lane_detection  # Funkcija za vraćanje na originalnu sliku
...
def process_video(input_video_path, output_video_path):
    ...
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Format izlaznog snimka
